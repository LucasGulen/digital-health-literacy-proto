  ...
  render() {
    return (
      <div>
        ...
        <span className={this.state.showScrollUp ? "show" : "hidden"} style={{ position: "fixed", right: "6%", bottom: "16%" }}>
          <Tooltip disableHoverListener={!this.state.showScrollUp}
            open={this.state.showScrollUp ? true : undefined}
            placement="left" title={this.state.showScrollUp ? "Remonter" : ''}>
            <span>
              <Button
                variant="fab"
                color="default"
